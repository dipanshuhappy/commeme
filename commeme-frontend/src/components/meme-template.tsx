...
// 	return (
// 		<div style={{ display: 'flex', flexFlow: 'column nowrap', width: '80vw', alignItems: 'center', justifyContent: 'center' }}>
// 			<div
// 				id='meme-download'
// 				style={{
...
// 			<div style={{ marginTop: '-1em', display: 'flex', width: '40%', justifyContent: 'space-around' }}>
// 				<button
