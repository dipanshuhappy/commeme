...
export default function Hero() {
 ...
 <HeroHighlight className='dark'>
  ...
  >
   ...
   <div className=" lg:text-2xl font-bold text-neutral-700 dark:text-white max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto my-3">Welcome to Commeme the ultimate platform where your memes can spark a revolution. Contribute to the meme economy and make degen positive sum. Let's Seize the memes of production ! </div>
  </motion.h1>
